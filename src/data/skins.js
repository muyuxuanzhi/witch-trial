...
export const CHARACTER_SKINS = [
  { id: "default", name: "见习魔女·紫", price: 0,   body: "#3d2a54", outline: "#b96bff", visor: "#4fe0d0", trail: "#4fe0d0" },
  { id: "cyan",    name: "碧海魔女", price: 40,  body: "#123240", outline: "#4fe0d0", visor: "#b96bff", trail: "#4fe0d0" },
  { id: "crimson", name: "绯红魔女", price: 80,  body: "#3a1020", outline: "#ff5c8a", visor: "#ffcf5c", trail: "#ff5c8a" },
  { id: "gold",    name: "黄金魔女", price: 150, body: "#3a2e10", outline: "#ffcf5c", visor: "#ffffff", trail: "#ffcf5c" },
];
