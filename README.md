...
<img src="assets/golden-witch.png" alt="黄金魔女 露娜" width="200" align="right">

在商城花费 **150 金币**即可解锁的第二个可玩魔女。

**露娜**是慵懒的电波系魔女，最爱坚果巧克力与一切金灿灿的东西。口头禅：「为了金灿灿和甜品……power！！！」解锁后同样从**水手服少女**初始形态出发，通过试炼逐级进化，走完整条形态进化线。

> 这个角色的幽默感在于她对金箔坚果巧克力的离谱执念——**剧情彩蛋**：通关并解锁黄金魔女皮肤，即可触发「终极甜蜜」隐藏成就（露娜给自己买 10 万箱金箔坚果巧克力庆祝通关）！
...
- **📖 图鉴系统**：角色设定（含叶林 & 露娜）、Buff 增益、Boss 图鉴，支持滚动浏览
